...
public class LOTRModelHalfTroll extends LOTRModelBiped {
	...
	public LOTRModelHalfTroll(float f) {
		...
		hornLeft1.rotateAngleZ = (float) Math.toRadians(-20.0);
		...
		hornLeft2.rotateAngleZ = (float) Math.toRadians(-40.0);
