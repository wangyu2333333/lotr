...
public class LOTRRecipes {
	...
	public static void createAllRecipes() {
		...
		LOTRRecipes.createCommonMorgulAndGundabadRecipes();
	...
	public static void createCommonMorgulAndGundabadRecipes() {
		LOTRRecipes.addRecipeTo(commonMorgulAndGundabadRecipes, new ShapedOreRecipe(new ItemStack(LOTRMod.chandelier, 2, 7), " X ", "YZY", Character.valueOf('X'), "stickWood", Character.valueOf('Y'), LOTRMod.orcTorchItem, Character.valueOf('Z'), LOTRMod.orcSteel));
		LOTRRecipes.addRecipeTo(commonMorgulAndGundabadRecipes, new ShapedOreRecipe(new ItemStack(LOTRMod.orcSteelBars, 16), "XXX", "XXX", Character.valueOf('X'), LOTRMod.orcSteel));
		LOTRRecipes.addRecipeTo(commonMorgulAndGundabadRecipes, new ShapedOreRecipe(new ItemStack(LOTRMod.orcBow), " XY", "X Y", " XY", Character.valueOf('X'), LOTRMod.orcSteel, Character.valueOf('Y'), Items.string));
		LOTRRecipes.addRecipeTo(commonMorgulAndGundabadRecipes, new ShapedOreRecipe(new ItemStack(LOTRMod.gateOrc, 4), "YYY", "YXY", "YYY", Character.valueOf('X'), LOTRMod.gateGear, Character.valueOf('Y'), LOTRMod.orcSteel));
		LOTRRecipes.addRecipeTo(commonMorgulAndGundabadRecipes, new ShapedOreRecipe(new ItemStack(LOTRMod.mechanism), " X ", "YZY", " X ", Character.valueOf('X'), "ingotCopper", Character.valueOf('Y'), Items.flint, Character.valueOf('Z'), LOTRMod.orcSteel));
	}
