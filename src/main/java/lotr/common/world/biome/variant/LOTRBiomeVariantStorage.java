...
public class LOTRBiomeVariantStorage {
	public static Map<LOTRDimension, Map<ChunkCoordIntPair, byte[]>> chunkVariantMap = new HashMap<>();
	public static Map<LOTRDimension, Map<ChunkCoordIntPair, byte[]>> chunkVariantMapClient = new HashMap<>();
