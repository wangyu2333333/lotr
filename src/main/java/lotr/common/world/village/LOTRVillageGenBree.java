...
public class LOTRVillageGenBree extends LOTRVillageGen {
	...
	public static class Instance extends LOTRVillageGen.AbstractInstance<LOTRVillageGenBree> {
		...
		public void setupHamlet(Random random) {
			...
			if (hamletHedge) {
				this.addStructure(getHamletHouseOrOther(random), -rHouse, 0, 1);
				this.addStructure(getHamletHouseOrOther(random), rHouse, 0, 3);
				this.addStructure(getHamletHouseOrOther(random), 0, rHouse, 0);
				int pathHouseX = 8;
				int pathHouseZ = innerSize + 16;
				this.addStructure(getHamletHouse(random), -pathHouseX, -pathHouseZ, 1);
				this.addStructure(getHamletHouse(random), pathHouseX, -pathHouseZ, 3);
			} else {
				this.addStructure(getHamletHouseOrOther(random), -rHouse, 0, 1);
				this.addStructure(getHamletHouseOrOther(random), rHouse, 0, 3);
				this.addStructure(getHamletHouseOrOther(random), 0, rHouse, 0);
				this.addStructure(getHamletHouseOrOther(random), 0, -rHouse, 2);
			}
		...
		public void setupVillage(Random random) {
			...
			this.addStructure(new LOTRWorldGenBreeGatehouse(false).setName(locationInfo.name), 0, -182, 0, true);
			int rHedge = 180;
